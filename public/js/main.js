...
function formComplete(){
    ...
    h1.appendChild(document.createTextNode(`Your request has been recieved, we will send you a code shortly to prompt your employer to finish the request, feel free to share, as its part of the steps before we mail it to you`));
    setTimeout(() => {
